function [tau, pd_foot, vd_foot, pfinal_foot, Fswing] = foot_placement_walking_sideways(p, R, v, p_hip, p_foot, v_foot, q, vd, t)
...
if 1-phase == 1
    pd_foot(2) = p_foot(2) + (t-phase_start) * pdelta_foot(2) / tswing;
    pd_foot(11) = p_foot(11) + (t-phase_start) *  pdelta_foot(11) / tswing;
    vd_foot(2) = pdelta_foot(2) / tswing;
    vd_foot(11) = pdelta_foot(11) / tswing;
    ...
    pd_foot(5) = p_foot(5) + (t-phase_start) * pdelta_foot(5) / tswing;
    pd_foot(8) = p_foot(8) + (t-phase_start) * pdelta_foot(8) / tswing;
    vd_foot(5) = pdelta_foot(5) / tswing;
    vd_foot(8) = pdelta_foot(8) / tswing;
    if t < (phase_start + tswing/2)
